...
text(K-2,2.75,'K_{50}','Rotation',90);

p1 = plot(0:agents,a0n2,'b','LineWidth',2,'DisplayName','\alpha = 0  , n_H = 2');
plot(0:K,ones(1,K+1)*a0n2(K+1),'--','Color',[0.8 0.8 0.8]);
a1 = annotation('textbox',[0.735 0.175 0.2 0.047]);
set(a1,'String','\alpha = 0, n_H = 2','FontName','Times New Roman',...
...
a2 = annotation('textbox',[0.715 0.295 0.22 0.047]);
set(a2,'String','\alpha = 0.5, n_H = 1','FontName','Times New Roman',...
    'FontSize',10,'LineStyle','none');

p3 = plot(0:agents,a1n,'g','LineWidth',2,'DisplayName','\alpha = 1');
plot(0:K,ones(1,K+1)*a1n(K+1),'--','Color',[0.8 0.8 0.8]);
a3 = annotation('textbox',[0.80 0.375 0.096 0.047]);
set(a3,'String','\alpha = 1','FontName','Times New Roman',...
    'FontSize',10,'LineStyle','none');

p4 = plot(0:agents,a2n05,'m','LineWidth',2,'DisplayName','\alpha = 2  , n_H = 0.5');
plot(0:K,ones(1,K+1)*a2n05(K+1),'--','Color',[0.8 0.8 0.8]);
a4 = annotation('textbox',[0.710 0.54 0.22 0.047]);
set(a4,'String','\alpha = 2, n_H = 0.5','FontName','Times New Roman',...
    'FontSize',10,'LineStyle','none');

p5 = plot(0:agents,a3n2,'k','LineWidth',2,'DisplayName','\alpha = 3  , n_H = 2');
plot(0:K,ones(1,K+1)*a3n2(K+1),'--','Color',[0.8 0.8 0.8]);
a5 = annotation('textbox',[0.735 0.81 0.2 0.047]);
set(a5,'String','\alpha = 3, n_H = 2','FontName','Times New Roman',...
    'FontSize',10,'LineStyle','none');
