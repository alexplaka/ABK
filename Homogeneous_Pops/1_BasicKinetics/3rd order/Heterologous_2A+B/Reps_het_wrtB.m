...
p1d = plot(t_sol,y_sol(:,1),'.b','MarkerSize',2,'DisplayName','DE_{ab}');        
p2d = plot(t_sol,y_sol(:,2),'.r','MarkerSize',2);
p3d = plot(t_sol,y_sol(:,3),'.g','MarkerSize',2);
...
%   This can be dealt with, but at the cost of programmatic simplicity.)
