...
totalTime = 1100;                  % Simulation time (sec)
...
%     [R_ss(s,:), Ep_ss(s,:)] = RateCurve_s;
    ...
    %   Average R population over the last 500 sec of the simulation
    %   Steady-state has been reached for this time period
    ABK_R_ss(s) = mean(Tr(end-500/dt:end));
...
% scatter(Rv(29,:),Epv(29,:),3,'.r');                    % plot stochastic trajectory
% scatter(Rv(69,:),Epv(29,:),3,'.g');                    % plot stochastic trajectory
% scatter(Rv(99,:),Epv(3,:),3,'.b');                    % plot stochastic trajectory
