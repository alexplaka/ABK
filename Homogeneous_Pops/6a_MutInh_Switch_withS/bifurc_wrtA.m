...
for i=1:size(A_ini,2)
    [t_sol, y_sol] = ode45(@mutual_withS_dif,0:totalTime/500:totalTime,[A_ini(i); B_ini]);
...
if isempty(bf)==1     
    disp('No bifurcations predicted wrt A_i');     
    return;     
end
