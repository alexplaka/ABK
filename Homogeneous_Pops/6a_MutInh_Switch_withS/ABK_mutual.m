...
Ta(1) = 100;                         Tb(1) = 0;			
% ************************************************************
% bifurc_wrtA(Ta(1),Tb(1));           % Get a sense of DE-predicted bifurcation
...
[t_sol, y_sol] = ode45(@mutual_withS_dif,0:maxTime/100:maxTime,[Ta(1) ; Tb(1)]);
...
fig0 = figure('Name','1st Order Rx w/ Mutual Feedback Time course','NumberTitle','off');
...
axis([0 t_sol(end) 0 agents]);                              % axis tight;
